    ...
    <div>
      ...
      <Grid container spacing={2}>
          <Grid className='blogfirst_banner' item xs={12} >
            <h2 className='blog_header'>Belichick on Verge of Becoming NFL's Biggest Loser</h2>
          </Grid>
        </Grid>
        <Grid container spacing={2}>
            <Grid item xs={8}>
                <img className='blog__img' style={{width:"90%",boxShadow:'0 0px 4px 0 rgba(0,0,0,0.2)'}} src={Social} alt='banner image'/>
                <h2 className='blog_title'>Belichick on Verge of Becoming NFL's Biggest Loser</h2>
            ...
            <Grid item xs={3}  style={{marginTop:'70px',boxShadow:'0 4px 8px 0 rgba(0,0,0,0.2)',padding:'20px',marginLeft:"50px",height:'400px',textAlign:'left' }}>
                ...
                <Link  to={'/blog/0' } style={{textDecoration: 'none',color:"#063769",backgroundColor:'#4975a18c',padding:'10px',borderRadius:'2Px',float:'left',marginBottom:'10px'}}><b>Fox News’s New Fight Club</b></Link>
          ...
          <Grid container spacing={2}>
            <Grid item xs={8}>
                <Typography variant="subtitle2" style={{textAlign:"left",paddingLeft:'50px',fontSize:'16px'}} gutterBottom>
                    ...
                    Bill Belichick Is on the Verge of Becoming the NFL’s Biggest LoserBy Nov. 27, 2023 7:00 am ETWhen the New England Patriots routinely churned out double-digit win seasons, Bill Belichick’s march
                    </Typography>
                    <Typography variant="subtitle2" style={{textAlign:"right",paddingLeft:'50px',fontSize:'16px',marginBottom:'50px'}} gutterBottom>
                        <Link target="_blank" to={"https://www.wsj.com/sports/football/bill-belichick-patriots-nfl-loss-record-9149f96d" } style={{textDecoration: 'none',color:"#063769"}}>Full Tutorial</Link>
                </Typography>
            </Grid>
